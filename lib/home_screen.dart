...
import 'package:pocket_pilot/goal_screen.dart';
...
class _HomeScreenState extends State<HomeScreen>{
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
                   ...
                   Text("${getGreeting()}, $username",
                    style: Theme.of(context).textTheme.titleLarge?.copyWith(
                          ...
                          IconButton(onPressed: () async{
                            await Navigator.push(context, MaterialPageRoute(builder: (_)=>GoalScreen())
                            );
                            loadGoal();
            ...
            goalCard(),
                ...
                child: PieChart(
                  PieChartData(
                    sections: getCategoryData().isEmpty
                ? [
                    PieChartSectionData(value: 1, title: "No Data"),
                  ]
                : getCategoryData().entries.map((e) {
  ...
  Widget goalCard(){
    ...
    double progress=goal==0 ? 0:(savings/goal).clamp(0,1);
    return Container(
      ...
      child:Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          Text("₹ ${savings.toStringAsFixed(0)} / ₹ ${goal.toStringAsFixed(0)}")
        ],
      )
    );
  }
